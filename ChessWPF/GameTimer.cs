...
namespace ChessWPF {
  public class GameTimer {
    ...
    private TimeSpan? timeSpanMaxWhite;
    private TimeSpan? timeSpanMaxBlack;
    ...
    public TimeSpan? MaxWhitePlayTime {
      get {
        return ( timeSpanMaxWhite );
      }
      set {
        timeSpanMaxWhite = value.Value;
      }
    }

    public TimeSpan? MaxBlackPlayTime {
      get {
        return ( timeSpanMaxBlack );
      }
      set {
        timeSpanMaxBlack = value.Value;
      }
    }
